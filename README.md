...
- `Наборы_доков_по_уровням_защищённости_ИСПДн.docx` — сводный справочник с таблицами:  
  **уровни защищённости → набор документов → нормативные основания → исполнители → проверяющие**
...
#### Файлы
- `Акт внутр контроля ИСПДн (шаблон).docx` — чистый шаблон для оформления внутреннего контроля в любой ИСПДн
- `Акт внутр контроля ИСПДн (пример).docx` — пример заполненного акта для вуза (3-й ур защищённости)
- `Акт внутр контроля универсальный.docx` — универсальный вариант акта для ГИС и КИИ (на основе ФЗ-149, ФЗ-187, ФСТЭК №17 и №239)
- `pd_audit_basics.md` — теоретическая часть: виды аудитов, нормативная основа, структура акта  
- `practice.md` — практические задания и кейсы

#### Что важно знать
- Периодичность контроля — не реже 1 раза в 3 года (ПП №1119 п.17)
- РКН проверяет законность обработки (ФЗ-152)
- ФСТЭК проверяет меры и документы (ФСТЭК 21)  
- ФСБ проверяет криптографию (ФСБ 378)
- Итог внутреннего аудита — акт и план корректирующих мероприятий
- Акт внутреннего контроля — **обязательное доказательство** выполнения мер, запрашивается при проверках ФСТЭК
- План корректирующих мероприятий оформляется **как Приложение №1** к акту
- Для КИИ и ГИС используется аналогичная форма, но с нормативами ФЗ-149, 187, ПП-127 и ФСТЭК-239 
